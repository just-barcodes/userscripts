...
// @description  automatically enter theatre mode on twitch
// @version      1
// @grant        none
...
waitForKeyElements('div.theatre-button', function () {
  document.querySelector('div.theatre-button a.button').click();
});
